                ...
                children: [
                  ...
                  SizedBox(height: space * .8,),
                   Expanded(
                      ...
                      child: Column(
                        children: [
                          const Text('She can help fill in the blanks', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold,),),
                          const Text("As well as give you clues to understand her better.", textAlign: TextAlign.center ,style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold),),
                          const Text("Curious? Find out how.", style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold, ),),
